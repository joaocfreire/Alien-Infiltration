...
class Editor:
    def __init__(self):
        ...
        self.assets = {
            ...
            'spawners': load_images('environments/spawners')
        }

        self.movement = [False, False, False, False]

        self.tilemap = Tilemap(self, tile_size=32, editor=True)
    ...
    def run(self):
        while True:
            ...
            if self.clicking and self.ongrid:
                self.tilemap.tilemap[f'{tile_pos[0]};{tile_pos[1]}'] = {'type': self.tile_list[self.tile_group],
